...
- Network embedding for node classification, link prediction and node retrieval, etc.
    ...
    - [SketchBANE](https://github.com/AlandBD/graph-hashing/tree/main/SketchBANE). W. Wu, S. Li, M. Jiang, C. Luo and F. Li, "Time- and Space-Efficiently Sketching Billion-Scale Attributed Networks," in IEEE Transactions on Knowledge and Data Engineering, vol. 37, no. 2, pp. 966-978, Feb. 2025.
