...
- Network embedding for node classification, link prediction and node retrieval, etc.
    ...
    - [VLS2ketch](https://github.com/AIandBD/graph-hashing/tree/main/VLS2ketch). Wei Wu, Shiqi Li, Ling Chen, Fangfang Li, and Chuan Luo. (2025). Sketching Very Large-scale Dynamic Attributed Networks More Practically. In Proceedings of the ACM on Web Conference 2025 (WWW '25). Association for Computing Machinery, New York, NY, USA, 5264–5274. https://doi.org/10.1145/3696410.3714519.
